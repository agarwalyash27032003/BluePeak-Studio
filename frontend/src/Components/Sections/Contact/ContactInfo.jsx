...
const ContactInfo = () => {
    return (
        <div className='mb-[5rem] lg:mb-0'>
            ...
            <h2 className="text-base mt-6 text-lg md:text-2xl dm-sans text-gray-400 mx-auto md:mx-0 text-justify">Let’s turn your vision into reality. Connect with us to discuss your project and explore how we can help.</h2>
